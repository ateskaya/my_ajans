...
<template>
    ...
    >
        ...
        <a
            ...
            class="relative inline-flex items-center gap-2 rounded-full bg-green-600/90 px-4 py-2.5 text-sm font-semibold text-white shadow-lg shadow-green-950/30 backdrop-blur-md transition-all duration-300 hover:scale-105 hover:bg-green-500 focus:outline-none focus:ring-2 focus:ring-green-400 focus:ring-offset-2 focus:ring-offset-slate-950"
        >
            <span
            ...
            <span class="relative">Bize Yazın</span>
        </a>
    </div>
</template>
