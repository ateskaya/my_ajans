...
const submit = () => {
    form.post(route('admin.client-projects.store'));
};
</script>

<template>
    <Head title="Yeni Müşteri Projesi" />

    <AdminLayout>
        <template #header>
            <div class="flex w-full items-center justify-between">
                <h1 class="text-lg font-semibold text-gray-900">Yeni Müşteri Projesi</h1>
                <Link
        ...
        >
            ...
            <div class="flex gap-3">
                ...
                >
                    {{ form.processing ? 'Kaydediliyor...' : 'Projeyi Oluştur' }}
                </button>
                <Link
                    :href="route('admin.client-projects.index')"
